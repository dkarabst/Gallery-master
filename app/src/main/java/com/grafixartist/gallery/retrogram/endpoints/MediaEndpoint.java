package com.grafixartist.gallery.retrogram.endpoints;


import com.grafixartist.gallery.retrogram.model.*;
...
public class MediaEndpoint extends BaseEndpoint {
    ...
    public SearchMediaResponse search(final Integer distance, final Double latitude, final Double longitude) {
        return mediaService.search(accessToken, distance, latitude, longitude, null, null);
    }
